...
## Usage
Self-contained web page is [here](index.html).

## Motivation
I prefer a tidier game table with only the components out that I need. Digging the unused Class sheets out of the box goes against this principle, plus they are rather floppy to handle for a random draw.
